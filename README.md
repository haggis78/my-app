...
![exist-db CI](https://github.com/haggis78/my-app/workflows/exist-db%20CI/badge.svg)

<img src="icon.png" align="left" width="25%"/>

My amazing my-app application
...
1.  Download  the `my-app-1.0.0.xar` file from GitHub [releases](https://github.com/haggis78/my-app/releases) page.
...
AGPL-3.0 © [bill-campbell](http://brecon.newtfire.org/)
...
[release-url]: https://github.com/haggis78/my-app/releases/latest
